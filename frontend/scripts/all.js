...
let lurl = "https://treand-bazaar-backend-lokendra-debug.vercel.app/all";
let lData= [];
let length;
let noOfPages;
let limit = 20;
...
let url2 = "https://treand-bazaar-backend-lokendra-debug.vercel.app/all?_sort=price&_order=asc";
let url3 = "https://treand-bazaar-backend-lokendra-debug.vercel.app/all?_sort=price&_order=desc";
...
if(queryArr.length>0){
    ...
    let url = `https://treand-bazaar-backend-lokendra-debug.vercel.app/all?q=${x}`;
    fetchData(url)
...
function filterPriceFun(){
    ...
    if(topSearch.value!=""){
                ...
                if(filterPrice.value=="asc"){
                    let url2 = `https://treand-bazaar-backend-lokendra-debug.vercel.app/all?_sort=price&_order=asc&q=${topSearch.value}`
                    console.log("INSIDE")
                    fetchData(url2)
                }
                if(filterPrice.value=="desc"){
                    let url3 = `https://treand-bazaar-backend-lokendra-debug.vercel.app/all?_sort=price&_order=desc&q=${topSearch.value}`
        ...
        if(filterPrice.value=="asc"){
            let url2 = `https://treand-bazaar-backend-lokendra-debug.vercel.app/all?_sort=price&_order=asc&_page=${count}&_limit=${limit}`;
            fetchData(url2)

        }

        if(filterPrice.value=="desc"){
            let url3 = `https://treand-bazaar-backend-lokendra-debug.vercel.app/all?_sort=price&_order=desc&_page=${count}&_limit=${limit}`;
            fetchData(url3)
        }
    }
